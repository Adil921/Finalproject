        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstName = table.Column<string>(type: "nvarchar(59)", maxLength: 59, nullable: false),
                    LastName = table.Column<string>(type: "nvarchar(59)", maxLength: 59, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SearchHistorys", x => x.SearchId);
                    table.ForeignKey(
                        name: "FK_SearchHistorys_Clients_ClientId",
                        column: x => x.ClientId,
                        principalTable: "Clients",
                        principalColumn: "ClientId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SearchHistorys_ClientId",
                table: "SearchHistorys",
                column: "ClientId",
                unique: true);
        }
